...
# クイズデータをリストで管理
quizzes = [
    {"question": "ワロタと同意義だが、何故かこっちを使いたくなる。\ちなみにわろしの意味は「よくない、不快」で笑うこととは一切関係がない。\出典は枕草子。", "answer": "わろし(古文)"},
    {"question": "聖地で生まれた伝説のワード。\n意味は詳しくは判らないが、恐らく「よく言うぜ」みたいな相手が過言を言ったときに使う言葉だと考察班は予想している。\n使用例　何？自殺するって？言うほど言うなぁ", "answer": "いうほどいう"},
    {"question": "考察班が一番好きなワード。\n意味は分からん。(絶望)\n恐らく、脅しのワードとして「キン○マ潰すぞ」という意味なのだろうが、謎の敬語と語呂の良さも相まって、人気を博している。", "answer": "しこたま踏ませて頂きます(迫真)"}
]
