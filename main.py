...
quizzes = [
    ...
    {"question": "ある一人の男子生徒が論理・表現の授業中、「これ二択だな」と何回も発言した。\n軽々しく二択という言葉を使ったクラスメイトに対して憤怒したﾀｸは「二択の保証しろ」と彼を怒鳴りつけた。\n語録の中では珍しく、文法的にも表現的にも歪みが見られない。", "answer": "二択の保証しろ"},
    ...
    {"question": "山地とスマホ卓球を楽しんでいたﾀｸ。真正面に鋭いストレートを放つも、更に速いスピードで返されてしまう。山地が勝利を確信した瞬間、その言葉は唐突に現れた。\n少なくとも私には、彼が脊髄反射でかの言葉を発したかのように感じられた。前世はスラム街の売春婦だったのだろうか。真相は液晶に映るピンポン玉と共に消えていった。", "answer": "妊娠するって！"},
    ...
    {"question": "次は選択授業。移動教室をしている際、突如として二人は口論をし始めた。俺はお前と同類じゃない、と熱く語るジョウバ。それに対し、お前は同類だと言って譲らないﾀｸ。五分五分かと思われた闘いは、常軌を逸した口頭表現によって一気に決着を付けられた。「お前も同類項じゃ！」時間が止まったかのような衝撃を受けた。いや、恐らく本当に止まっていただろう。唖然とするジョウバを気にも留めず、彼の足は颯爽と書写室のある別棟へ向かっていった。", "answer": "お前も同類項じゃ"},
