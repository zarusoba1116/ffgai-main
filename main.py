...
quizzes = [
    ...
    {"question": "ツムツムのパチンコエルサに大敗北したﾀｸ。神に祈ることこそがパチエルで荒稼ぎする最適解だと判断したﾀｸは、エジプトの冥界神であるアヌビスにその身を捧げた。\n…が、「ヌ」が抜けてしまった。「アビス」へと変わってしまった。冥界神ではなく、冥界そのものを崇拝してしまったﾀｸ。今後、彼の身に何か不幸が訪れないことをただ祈るばかりだ。", "answer": "アビス(奈落崇拝)"}
]
